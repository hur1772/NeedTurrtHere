...
namespace SungJae
{
    public class AirStrikeCtrl : Turret_Ctrl
    {
        ...
        void Start()
        {
            //SpEndpos = this.transform.position;
        ...
        void OnDrawGizmos()
        {
            ...
            Gizmos.DrawWireCube(transform.position, new Vector2(4.0f, 4.0f));
        }
        ...
        public void CheckAttSensor()
        {
            ...
            if (airstrike.transform.position.y <= SpEndpos.y)
            {
                ...
                Collider2D[] colls = Physics2D.OverlapBoxAll(airstrike.transform.position, new Vector2(4.0f, 4.0f), 0, enemylayer);
                //Debug.Log(colls);
